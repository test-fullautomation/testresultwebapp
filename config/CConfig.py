...
class CConfig():
    ...
    def __init__(self, sReferencePath="."):
        ...
        # 1. basic setup stuff
        self.__dictConfig['sPackageName']                = "TestResultWebApp"
        self.__dictConfig['sVersion']                    = "0.0.0"
        self.__dictConfig['sAuthor']                     = "Thomas Pollerspöck"
        self.__dictConfig['sAuthorEMail']                = "Thomas.Pollerspoeck@de.bosch.com"
        self.__dictConfig['sDescription']                = "This package provides a generic web based open source application which allows processing displaying of test result data in a sophisticated way."
        self.__dictConfig['sLongDescriptionContentType'] = "text/markdown"
        self.__dictConfig['sURL']                        = "https://github.com/test-fullautomation/testresultwebapp"

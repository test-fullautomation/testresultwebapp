...
class CRepositoryConfig():
    ...
    def __init__(self, sCalledBy=None):
        ...
        # (usually taken from any Python source file of the package, but in this case we do not have Python source files;
        # nevertheless we have to make a mapping here to GenpackageDoc compatible key names)
